	...
	<div class="container">
		...
		<div class="card mt-5">
			...
			<div class="card-body">
				...
				<a href="/guru/kembalikan_semua" class="btn btn-sm btn-info">Kembalikan Semua</a>
				
				<a href="/guru/hapus_permanen_semua" class="btn btn-sm btn-info" >Hapus Permanen Semua</a>
				<br/>
				<br/>
